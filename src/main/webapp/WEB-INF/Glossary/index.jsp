...
<li>
 <section>
   ...
   <div class="box">
     <p>1. インタラクティブモジュール。モジュールの解除に、分析担当者と処理担当者のやり取りが必須であるモジュールのこと。バニラモジュールの「記憶」や「表比較」のように複数のステージを含むものを指すことが多い。<br>これに対して、バニラモジュールの「コード」や「キーパッド」のような、モジュールの情報を分析担当者に与えるだけでマニュアルから答えを得られるモジュールを「ノンインタラクティブモジュール」という。<br><br>
